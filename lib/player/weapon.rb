module Game
  class Weapon
    attr_reader :damage, :sprite, :attack_sprites

    def initialize(damage, sprite_path, attack_sprites_paths)
      @damage = damage
      load_sprites(sprite_path, attack_sprites_paths)
      @attack_frame = 0
    ...
    def load_sprites(sprite_path, attack_sprites_paths)
